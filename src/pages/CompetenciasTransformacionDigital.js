...
function CompetenciasTransformacionDigital({ title }) {
  const settings = {
    dots: true,
    infinite: true,
    speed: 300,
            ...
            <div>
              <h1 class="text-4xl mb-5 font-bold">
                ...
                <span class="text-indigo-300">
                  {''} Competencias Docentes Para La Transformación Digital
                </span>
              </h1>
              <h2 class="text-md mb-12">
                Formar Doctores en Competencias Docentes para la Transformación Digital capaces de
                ...
                de docencia, así como desarrollar proyectos de investigación enfocados a solucionar
                situaciones educativas aplicando el método científico y fundamentados en las teorías
                educativas y en el uso de los recursos digitales que ofrece la transformación
                digital.
              </h2>
              <div class="flex">
                <div class="mr-8">
                  <p class="text-2xl font-bold">RVOE</p>
                  <p class="text-sm">20211666</p>
                </div>
                <div class="mr-8">
      ...
      <SplitSection
        primarySlot={
          <div className="lg:pr-16 xl:pr-16">
            ...
            <p className="mt-8 text-xl font-light leading-relaxed">
              • Experiencia laboral como docente <br /> • Grado de maestría
            </p>
          </div>
        }
      />
...
export default CompetenciasTransformacionDigital;
